...
int enc[30]={4034930931, 1624612769, 2616466840, 816575390, 3068937114, 3910182655, 3843825438, 4239625657, 3810795230, 4001007650};
// tjctf{Th15_1s_f@k3_fl4g_ggg_f1nd_@gagn}
int run(const char *buf)
{   
    for (int i = 0; buf[i]; i++){
        char ver=(buf[i]^i)-*((char*)enc+i);
        // printf("%d %d %d %d\n",*((char*)enc+i),buf[i],ver,ptrace(PTRACE_TRACEME,0));
        if (ver)
            return 0;
    }
    return 1;
...
{
    // tjctf{72b4z6aa7eu5805-6deyd48_b1285b8c}
    int tmp[] = { 4034962675, 1753522081, 3772868126, 921554324, 2347873364, 3867416929, 388860845, 1780009808, 891589781, 4000993943};
